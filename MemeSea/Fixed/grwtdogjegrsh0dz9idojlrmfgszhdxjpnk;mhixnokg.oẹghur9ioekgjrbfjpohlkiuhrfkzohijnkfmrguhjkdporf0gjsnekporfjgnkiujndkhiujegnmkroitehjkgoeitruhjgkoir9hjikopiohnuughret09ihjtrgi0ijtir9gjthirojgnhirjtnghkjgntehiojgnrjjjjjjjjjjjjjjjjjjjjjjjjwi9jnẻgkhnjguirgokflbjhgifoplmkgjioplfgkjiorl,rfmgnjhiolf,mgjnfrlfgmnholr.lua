...
local redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/BinbinvoGamingVNClone/RedzLibV5/refs/heads/main/RedzLibV5.lua",true))()
local Window = redzlib:MakeWindow({ Title = "BinbinvoGaming Hub - Meme Sea", SubTitle = "By binbinvogaming - lib by redz9999", SaveFolder = "BinbinvoGamingHub-MemeSea.json" })
Window:AddMinimizeButton({
  Button = { Image = "rbxassetid:/80935084928352", BackgroundTransparency = 0 },
